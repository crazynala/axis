...
import { Button, Checkbox, Select, Table, TextInput, Group, Stack, Title } from "@mantine/core";
...
export default function CompaniesRoute() {
  ...
  const form = useForm<{ name: string | null; type: string | null; is_active: boolean; notes: string | null }>({
